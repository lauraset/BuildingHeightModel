...
class feature_extraction(nn.Module):
    def __init__(self, n_channels=3):
        ...
        self.firstconv = nn.Sequential(convbn(self.n_channels, 32, 3, 2, 1, 1),
                                       nn.ReLU(inplace=True),
        ...
        #self.layer2 = self._make_layer(BasicBlock, 64, 16, 2,1,1) original
        self.layer2 = self._make_layer(BasicBlock, 64, 3, 2, 1, 1) # changed to simple one
